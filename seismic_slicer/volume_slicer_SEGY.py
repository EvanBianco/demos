...
################################################################################
# Create some data
seismic = np.loadtxt('Penob_sm_100_100_500')
nILnXL, nt = seismic.shape
nIL = 100
nXL = 100
# in this example
# inline range = 1000-1499 (500)
# xline range = 1000-1399 (400)
# twt range = 0-3996 @ 4ms (1000)
data = np.reshape( seismic,(nIL,nXL,nt) )
#reverse trace ordering (for plot only) - this could be improved
data = data[:,:,0:200]
data = data[:,:,::-1]
################################################################################
